                        ...
                        {currentStep === 0 && (
                            <div>
                                <div
                                    ...
                                    <Text name={'First Name'} value={profileData.first_name} disp='first_name'
                                          setValue={setProfileData} col={'3'}/>
                                    <Text name={'Last Name'} value={profileData.last_name} disp='last_name'
                                          setValue={setProfileData} col={'3'}/>
                                    <Text name={'Date of birth'} value={profileData.date_of_birth} disp='date_of_birth'
                                    ...
                                    <Text name={'Phone Number'} value={profileData.phone_number} disp='phone_number'
                          ...
                          <div className="relative mt-2 rounded-md shadow-sm">
                            ...
                            />
                                    ...
                                    <Text name={'Email'} value={profileData.email} disp='email'
                        ...
                        {currentStep === 1 && (
                            <div>
                                <div
                                    className="bg-gray-200 rounded-lg p-10 mb-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 border-b">
                                    {/* <h2 className="text-2xl font-semibold mb-4 tracking-wide">{steps[currentStep]}</h2> */}
                                    <Text name={'College Name'} value={profileData.college_name} disp='college_name'
                                          setValue={setProfileData} col={' col-span-full'}/>
                                    <Select name={'Degree'} value={profileData.degree} disp='degree'
                                            setValue={setProfileData} col={'2'} options={['B.Tech', 'B.Comm', 'B.Sc']}/>
                                    <Text name={'Branch / Discipline'} value={profileData.branch} disp='branch'
                                          setValue={setProfileData} col={'2'}/>
                                    <Text name={'Minor Branch'} value={profileData.minor_branch} disp='minor_branch'
                                          setValue={setProfileData} col={'2'}/>

                                    {/* MM YYYY ONLY */}
                                    <Text name={'Start Date'} value={profileData.course_started} disp='course_started'
                                          setValue={setProfileData} type={'date'} col={'3'}/>
                                    ...
                                    <Text name={'CGPA / Percentage'} value={profileData.cgpa} disp='cgpa'
                                          setValue={setProfileData} col={'2'}/>
                                    ...
                                    <Select name={'12th Board'} value={profileData.class_12_board} disp='class_12_board'
                                            setValue={setProfileData} col={3} options={['CBSE', 'ISC', 'State Board']}/>
                                    <Text name={'12th Percentage'} value={profileData.class_12_percentage}
