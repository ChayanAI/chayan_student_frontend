      ...
      <div className="mt-2">
        {variant === 'input' && (
          ...
          <input
            ...
            step={step}
            autoComplete={stringify(name)}
            className="block w-full rounded-md border-0 py-1.5 dark: text-gray-900 shadow-sm ring-1 ring-inset dark:bg-[#d0cfd1] ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
          />
        )}
        {variant === 'select' && (
          isRequired ? 
          ...
          <select
            ...
            name={stringify(name)}
            autoComplete={stringify(name)}
            className="block w-full rounded-md border-0 py-1.5 dark:bg-[#d0cfd1] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:max-w-xs sm:text-sm sm:leading-6"
          >
            {options && options.map((option, index) => (
              <option key={index} value={option}>
                {option}
