...
const PersonalInformation = ({userId, profileData, setProfileData}) => {
    ...
    if (!loader) {
        ...
        return (
            <div className="px-10 pb-10 mb-6 grid grid-cols-1 gap-x-10 gap-y-8 sm:grid-cols-6">
                ...
                <Text name={'Date of birth'} value={formatDate(profileData.date_of_birth)}
                    isRequired={true}
                    disp='date_of_birth'
                    setValue={setProfileData} type={'date'} col={'2'}/>
                <ComboBox name={'Hometown'} value={profileData.city} disp='city'
                    setValue={setProfileData} col={'2'} isRequired={true}
                ...
                <Select name={'Gender'} isRequired={true} value={profileData.gender}
                    disp='gender'
                ...
                <div className="flex col-span-2 relative">
                    ...
                    <button className="absolute bottom-[10px] right-2 rounded-md px-3 py-1 bg-blue-300 font-semibold text-blue-600 text-xs">Get OTP</button>
                </div>
                <div className="flex col-span-2 relative">
                    <OtpInput numDigits={4} />
                </div>
